...
**StudyBuddy** is a console-based C++ application created as a first-year project to practice core programming concepts such as file handling, functions, and structured program flow.  
The project focuses on learning through interactive notes and topic-based quizzes.
...
| Function | Purpose |
|--------|---------|
| `waitDots()` | Displays a simple loading effect |
| `slowPrint()` | Prints text with delay |
| `showNotes()` | Displays topic notes |
| `takeQuiz()` | Loads and runs quizzes |
| `saveResult()` | Saves results to file |
| `getPreviousResult()` | Retrieves past scores |
| `showResult()` | Displays result summary |
...
🔗 **[Watch Project Explanation Video](https://youtu.be/_0Kh_S2AY4Q)**
...
**StudyBuddy – Virtual Teacher System**
